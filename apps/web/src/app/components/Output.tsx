...
const Output = ({
  ...
  }, [executionId, hasLoaded]);
  return (
    <>
      {executionResult?.data.verdict === "Compilation Error" && hasLoaded ? (
      ...
      {executionResult?.data?.verdict === "Runtime Error" && hasLoaded ? (
      ...
      {executionResult?.data?.verdict === "Executed" && hasLoaded ? (
