            ...
            {executionHistory &&
              executionHistory.data.data.map((data, idx) => (
                ...
                (<tr key={idx} className="p-3 bg-neutral-900">
                  <td scope="row" className="p-3 px-10">{data.id}</td>
                  <td className="p-3 px-10">{data.lang}</td>
                  <td className="p-3 px-10">{data.status}</td>
                  <td className="p-3 px-10"><Badge executionResult={data.verdict}/></td>
                  <td className="p-3 px-10"><a href={`/my-codes/view/${data.id}`}>View</a></td>
                </tr>):
